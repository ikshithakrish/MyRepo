...
public class FileHandling {
	...
	public static List<String>[] ALL_ROW_DATA = null;
	
	public static Logger LOGGER = Logger.getLogger(FileHandling.class);
		
	// Read ROW(s) Data from Excel Sheet - BEGINs
	public static List<String>[] readRowData(String filePath, String sheetNameParam){  // return the Array of ArrayList
		try{
			...
			if(filePath.lastIndexOf(".") >=0 ){  // if check index "." - BEGIN
				...
				LOGGER.error("No extenison found");
					...
					if(ObjectNullChecker.checkNPE(EXCEL_SHEET = EXCEL_DOC.getSheet(sheetNameParam), "invalid sheet name")){  //if true sheetObject is  null - BEGIN  
